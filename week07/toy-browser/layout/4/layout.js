...
function layout(element) {
  ...
  if (mainSpace < 0) {
    // overflow (hanppens only if container is single line), scale every item
    ...
    flexLines.forEach((items) => {
      ...
      if (flexTotal > 0) {
        ...
        // There is *NO* flexible flex items, justifyContent should work
  ...
  flexLines.forEach((items) => {
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      if (align === 'flex-end') {
        ...
        itemStyle[crossEnd] = itemStyle[crossEnd] - crossSign * lineCrossSize;
      }
      if (align === 'center') {
      ...
      if (align === 'stretch') {
        ...
        itemStyle[crossEnd] =
          crossBase +
          crossSign *
            (itemStyle[crossSize] !== null && itemStyle[crossSize] !== void 0 ? itemStyle[crossSize] : lineCrossSize);
